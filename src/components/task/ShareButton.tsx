...
export default function ShareButton() {
  ...
  return (
    <div className="flex items-center gap-2">
      <button
        onClick={handleCopy}
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-gray-100 dark:bg-zinc-800 text-gray-600 dark:text-zinc-400 hover:bg-gray-200 dark:hover:bg-zinc-700 transition-colors"
      >
        {copied ? (
          <>
      ...
      <button
        ...
        className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-[#2AABEE]/10 text-[#2AABEE] hover:bg-[#2AABEE]/20 transition-colors"
        title="Telegram"
      >
